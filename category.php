                                        ...
                                        <div class="axil-product product-style-six">
                                             <div class="thumbnail">
                                                  <a href="product.php?id=<?php echo $value['id']; ?>">
                                                       <img data-sal="fade" style="height:260px;width:260px;"
                                                            data-sal-delay="100" data-sal-duration="1500"
                                                            src="admin/images/category/<?php echo $value['photo']; ?>"
                                                            class="img-fluid" alt="Product Images">
                                                  </a>
                                             </div>
                                             <div class="product-content">
                                                  <div class="inner">
                                                       <h5 class="title"><a href="single-product-7.html" class="h5">
                                                                 <?php echo $value['title'] ?> <span class="verified-icon"><i
                                                                           class="fas fa-badge-check"></i></span>
                                                            </a></h5>
                                                       <div class="product-hover-action">
                                                            <ul class="cart-action">
                                                                 <li class="select-option"><a
                                                                           href="product.php?id=<?php echo $value['id']; ?>">View
                                                                           Product</a></li>
                                                            </ul>
                                                       </div>
                                                  </div>
