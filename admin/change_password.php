                    ...
                    <div class="container-login100">
                         <div class="row">
                              <div class="col-12 " style="width:450px;"> 
                                   <form class="card shadow-none" action="submit/admin_change_password.php" method="post"> 
                                                            <!--  action="submit/admin_change_password.php" -->
                                                            <!--  action="submit/seller_change_password.php" -->
                                        <div class="card-body">
                                             <div class="text-center">
